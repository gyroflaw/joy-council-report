...
import { ProposalFieldsFragment } from "@/queries/qntypes";
...
export const proposalActiveStatuses: ProposalStatus[] = [
  "deciding",
  "gracing",
  "dormant",
];

export const isProposalActive = (status: ProposalStatus) =>
  proposalActiveStatuses.includes(status);
